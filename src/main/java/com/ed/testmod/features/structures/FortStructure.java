...
public class FortStructure extends Structure<NoFeatureConfig> {
	public FortStructure(Function<Dynamic<?>,? extends NoFeatureConfig> config) {
		super(config);
	...
	public IStartFactory getStartFactory() {
		// TODO Auto-generated method stub
		return FortStructure.Start::new;
	}

	@Override
	public String getStructureName() {
		// TODO Auto-generated method stub
		return MainTM.MODID + ":fort";
	}
	...
	public static class Start extends StructureStart{
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templatemanagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			FortPieces.start(templatemanagerIn,pos,rotation,this.components,this.rand);
			this.recalculateStructureSize();
			MainTM.LOGGER.info("We can find a fort at:" + pos);
		}
