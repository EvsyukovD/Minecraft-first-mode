...
public class BarrackPieces {
public static final ResourceLocation PART_1 = new ResourceLocation(MainTM.MODID,"barrack");
//public static final ResourceLocation PART_2 = new ResourceLocation(MainTM.MODID,"barrack2");
private static final Map<ResourceLocation,BlockPos> OFFSET = ImmutableMap.of(PART_1,new BlockPos(0,1,0)/*,PART_2,new BlockPos(0,1,09)*/);
...
public static void start(TemplateManager manager,BlockPos pos,Rotation rot,List<StructurePiece> pieces,Random rand) {
	...
	pieces.add(new BarrackPieces.Piece(manager,PART_1,blockpos,rot));
	...
	*/
	...
	public static class Piece extends TemplateStructurePiece{
		...
		public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos,
				Rotation rotationIn) {
			super(ModFeatures.BARRACK_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = BarrackPieces.OFFSET.get(resourceLocation);
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
			super(ModFeatures.BARRACK_PIECE, tagCompound);
		...
		protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand,
			...
			if ("chest".equals(function)) {
				...
				if (tileentity instanceof ChestTileEntity) {
					...
					ResourceLocation ltable = new ResourceLocation(MainTM.MODID,"chest/barrack");
			...
			if ("big_chest".equals(function)) {
				...
				if (tileentity instanceof ChestTileEntity) {
					// here you can set any loot tables for the chests
					ResourceLocation ltable = new ResourceLocation(MainTM.MODID,"big_chest/barrack");
					((ChestTileEntity)tileentity).setLootTable(ltable, rand.nextLong());
				}
			}
		}
		...
		public boolean create(IWorld worldIn, ChunkGenerator<?> generator, Random randomIn,
			...
			PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation)
					.setMirror(Mirror.NONE);
			BlockPos blockpos = BarrackPieces.OFFSET.get(this.resourceLocation);
